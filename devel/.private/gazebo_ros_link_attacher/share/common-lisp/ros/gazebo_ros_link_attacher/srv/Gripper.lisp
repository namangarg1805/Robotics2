...
(cl:defmethod cl:initialize-instance :after ((m <Gripper-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Gripper-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_ros_link_attacher-srv:<Gripper-request> is deprecated: use gazebo_ros_link_attacher-srv:Gripper-request instead.")))

(cl:ensure-generic-function 'activate_gripper-val :lambda-list '(m))
(cl:defmethod activate_gripper-val ((m <Gripper-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_ros_link_attacher-srv:activate_gripper-val is deprecated.  Use gazebo_ros_link_attacher-srv:activate_gripper instead.")
  (activate_gripper m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Gripper-request>)))
  ...
  "gazebo_ros_link_attacher/GripperRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Gripper-request)))
  "Returns string type for a service object of type 'Gripper-request"
  "gazebo_ros_link_attacher/GripperRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Gripper-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Gripper-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name gazebo_ros_link_attacher-srv:<Gripper-response> is deprecated: use gazebo_ros_link_attacher-srv:Gripper-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <Gripper-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader gazebo_ros_link_attacher-srv:result-val is deprecated.  Use gazebo_ros_link_attacher-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Gripper-response>)))
  ...
  "gazebo_ros_link_attacher/GripperResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Gripper-response)))
  "Returns string type for a service object of type 'Gripper-response"
  "gazebo_ros_link_attacher/GripperResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Gripper)))
  ...
  "gazebo_ros_link_attacher/Gripper")